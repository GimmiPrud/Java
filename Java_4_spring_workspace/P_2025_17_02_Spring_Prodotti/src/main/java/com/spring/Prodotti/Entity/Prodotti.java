...
public class Prodotti {
	...
	public Prodotti(int iD, String marca, String modello, String descrizione, Double prezzo_consigliato,
			Double prezzo_massimo, Integer quantità, String categoria) {
		super();
		ID = iD;
		this.marca = marca;
